    ...
    def __init__(self, num_of_layers, num_heads_per_layer, num_features_per_layer, add_skip_connection=True, bias=True,
        ...
        for i in range(num_of_layers):
            layer = GATLayerImp3(
                ...
                return_edge_features=False if i < num_of_layers - 1 else True, # last GAT layer returns edge features
...
class GATLayer(torch.nn.Module):
    ...
    def __init__(self, num_in_features, num_out_features, num_of_heads, return_edge_features, concat=True, activation=nn.ELU(),
...
class GATLayerImp3(GATLayer):
    ...
    def __init__(self, num_in_features, num_out_features, num_of_heads, concat=True, return_edge_features=False, activation=nn.ELU(),
                 dropout_prob=0.6, add_skip_connection=True, bias=True, log_attention_weights=False):

        # Delegate initialization to the base class
        super().__init__(num_in_features, num_out_features, num_of_heads, return_edge_features, concat, activation, dropout_prob,
    ...
    def forward(self, data):
        ...
        # shape = (N, NH, FOUT)
        out_nodes_features = self.aggregate_neighbors(nodes_features_proj_lifted_weighted, edge_index, in_nodes_features, num_of_nodes, return_edge_features=self.return_edge_features)

        print(out_nodes_features.shape, out_nodes_features.dtype, out_nodes_features[:1])
    ...
    def aggregate_neighbors(self, nodes_features_proj_lifted_weighted, edge_index, in_nodes_features, num_of_nodes, return_edge_features=False):
        ...
        if return_edge_features:
            print(trg_index_broadcasted.shape, trg_index_broadcasted.dtype)
            return trg_index_broadcasted
